...
#OLD_monitdg_stop_service_monitdg()
#{
#echo monitdg_daemon STOP
#local ourcfg=${MONITZG_workdir}"/"$monit_config_name_use
#
#local _run="$monitdg_bin_path -c $ourcfg  -p $MONITZG_workdir/monit.pid 
# -s $MONITZG_workdir/monit.state quit"
#echo ${_run}
#${_run}
#}
...
monitdg_cli_help()
{
dgridsys_s;echo "monitdg CMDONE - <xxx> <yyy> .... -"
