...
dgridsys_cli_help_cfgfiles() {
  #echo -n
  dgridsys_s
  echo "nodecfg cfgtrace <rel cfg path> - trace of cfg relative path, sample: etc/1.conf"
  dgridsys_s
  echo "nodecfg cfgvarshow <varname> [<rel cfg path>] - show variable on diff nodes"
